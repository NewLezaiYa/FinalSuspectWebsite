...
[简体中文](README.md) [繁體中文](README.tw.md)

## Usage Instructions

- **Home Page** (`index.html`): Provides an overall introduction to the project and entry points.
- **Function Page** (`Features/`): Demonstrates specific mod features, such as music control and log uninstallation.
...
- **Tutorial Page** (`Guide/`): Details the mod's installation, update process, and log output methods.
- **Q&A Page** (`FAQ.html`): Frequently asked questions to help users quickly resolve doubts.
