/* ============================================================================
 * FinalSuspect Website — SplashIntro.js（机械启动序列）
 * 全屏 cold-boot 动画：装订线扫描 → 齿轮咬合 → Logo 装配展开 →
 *                      系统自检日志 → 资源校验 → 液压合闸 → 落幕
 * 对外只暴露 window.SplashIntro.start({ images, onComplete })
 * ========================================================================== */
window.SplashIntro = (function () {
  ...
  /* ---- 阶段 2：Logo 装订式展开（clip-path 从左到右装配） ---- */
